...
- Working group 236 - Sustainable Management of the Navigability of Natural Rivers - Hiver, Huber, Mosselman & Creech (co-Chairs).  
...
- The use of nature-based solutions in ports, harbors, and navigable waterways with a specific emphasis on recent initiatives from the World Bank, PIANC, and the US Army Corps of Engineers. **ADD THIS CONTENT**.
...
- An overview of PIANC Working Group 128 from the Chairman. [Slides from Dr. Bernhard Söhngen](PIANC_SmartRivers_WG128_Overview_Söhngen.pdf).  
- Review of families of technical-biological bank protection methods. **ADD SLIDES from Dr. Kyle McKay**.  
